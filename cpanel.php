            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="example-nav-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="nomination.html"><span class="subFont"><strong>Nomination's
                                        List</strong></span></a></li>
                        <li><a href="changePassword.php"><span class="subFont"><strong>Admin's
                    ...
                    <span class="normalFont"><a href="index.html"
                            class="btn btn-success navbar-right navbar-btn"><strong>Sign
                                Out</strong></a></span></button>
                </div>
            ...
            <div class="row">
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Computer science</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Electrical</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Mechanical</strong><br>";
                  echo "
                  <div class='progress'>
